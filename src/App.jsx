      ...
      >
        <div className=" flex flex-wrap justify-center items-center h-screen inset-x-0 px-2">
          ...
          <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-9 py-6 rounded-xl">
            ...
            <button onClick={() => setColor("red")} className="outline-none px-6 bg-[red] py-4 rounded text-black font-bold shadow-3xl">Red</button>
            ...
            <button onClick={() => setColor("violet ")} className="outline-none px-6 bg-[violet] py-4 rounded-lg text-black font-bold shadow-3xl">Violet</button>
          </div>
